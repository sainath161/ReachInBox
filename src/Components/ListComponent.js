...
const ListComponent = ({
  ...
  const formattedDate = `${monthName} ${day}, ${year} ${formattedHours}:${formattedMinutes} ${ampm}`;
    ...
    <>
      ...
      >
        <div className="flex justify-between">
          ...
          <p className="text-gray-600 font-bold mt-1">{formattedDate}</p>
        </div>
        <p className="mt-2 text-gray-500">from : {fromEmail} cc :</p>
